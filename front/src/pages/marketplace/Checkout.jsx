...
import { CreditCard, MapPin, ShoppingBag, Trash2, Banknote } from 'lucide-react';
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                            ...
                            <div className="flex flex-col gap-1" style={{ gridColumn: 'span 2' }}>
                                <input
                                    ...
                                    className={errors.addressLine ? 'error-ring' : ''}
                                    readOnly={step === 2}
                                />
                                {errors.addressLine && <small style={{ color: 'var(--error)', fontSize: '0.75rem' }}>{errors.addressLine}</small>}
                            </div>
                            <div className="flex flex-col gap-1">
                                <input
                                    type="text"
